...
def get_weather(city):
    weather_key ='0f767479df225aa16b5bcb4662c3de7b'
...
button = tk.Button(frame,text="Find",font=('Arial', 20,'italic bold'),bd=8,padx=16,pady=16 ,command=lambda: get_weather(entry.get()),activebackground='green',activeforeground='white',bg='powder blue')
